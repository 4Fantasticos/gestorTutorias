...
urlpatterns = patterns('',
                       ...
                       url(r'^miPanel/pedirTutoria', views.pedir_tutoria, name='pedir_tutoria'),
                       ...
                       url(r'^miPanel/misHorarios/eliminar/(?P<horario_id>\d+)/$', views.eliminar_horario,
                       ...
                       # Panel
                       url(r'^miPanel/$', views.mi_panel, name='miPanel'),
                       url(r'^miPanel/addAsignaturasAlumno', views.add_asignaturas_alumnos,
                           name='add_asignaturas_alumno'),
                       url(r'^miPanel/addGradosProfesor', views.add_grados_profesor, name='add_grados_profesor'),
                       url(r'^miPanel/addAsignaturasProfesor', views.add_asignaturas_profesor,
                           name='add_asignaturas_profesor'),
                       url(r'^miPanel/notificacionesAlumno', views.notificaciones_alumno,
                           name='notificaciones_alumnos'),
                       url(r'^miPanel/notificaciones', views.notificaciones_profesor, name='notificaciones_profesor'),
                       # Admin Django
