...
urlpatterns = patterns('',
                       ...
                       url(r'^miPanel/addAsignaturasAlumno', views.add_asignaturas_alumnos,name='add_asignaturas_alumno'),
                       ...
                       url(r'^miPanel/notificacionesAlumno',views.notificaciones_alumno, name='notificaciones_alumnos'),
